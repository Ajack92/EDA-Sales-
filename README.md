...
----Date exploration ---first and last date
...
----Generate a report that showws all key metrics of the business
...
-----what is the distribution of sold itemns across countries
select
c.country,
...
-----which 5 sub_category generate the highest revenue?
...
------what are the 10 worst performing products in terms of sale?
...
------what are the 10 worst subcategory products in terms of sale?
...
--the top 3 customers with fewest orders
